...
// Default constructor, using parameter initialisation to set m_value to "0"
bigint::bigint() : m_value("0") {}

// Constructor that takes an unsigned int as parameter
...
bigint operator+(const bigint &a, const bigint &b)
{
    ...
    // important to cast to int befor substracting - 1, because if it 0 it will underflow
    int i = (int)A.size() - 1;
    int j = (int)B.size() - 1;
    int carry = 0;
